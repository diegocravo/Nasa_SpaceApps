...
export default function TemporaryDrawer() {
        ...
        <Router>
            ...
            >
                ...
                <List>
                    ...
                    <ListItem button key="Ranking" onClick={() => history.push("/rank")}>
                        <ListItemIcon>
    ...
    return (
        <div style={{ height: "60px", display: "flex", justifyContent: "space-between", alignItens: "center" }}>
            ...
            <div style={{ width: "400px", display: "flex", justifyContent: "center", alignItens: "center", padding: "10px", marginRight: "30px" }}>
                <Stack direction="row" spacing={3}>
                    <div style={{display: "flex", justifyContent: "center", alignItens: "center"}}>
                    <MilitaryTechIcon style={{color: "#EBDE01"}} />
                    <Typography style={{color: "#9214B5", fontWeight: "bold"}} variant="subtitle1" gutterBottom component="div">
                            110
                    </Typography>
                    </div>
                    <div style={{display: "flex", justifyContent: "center", alignItens: "center"}}>
                    <MonetizationOnIcon style={{color: "#EBDE01"}} />
                    <Typography style={{color: "#9214B5", fontWeight: "bold"}} variant="subtitle1" gutterBottom component="div">
                            25
                    </Typography>
                    </div>
